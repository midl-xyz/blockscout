defmodule BlockScoutWeb.CSPHeader do
  ...
  def call(conn, _opts) do
    ...
    js_deliver_cdn_url = "https://cdn.jsdelivr.net"
    ...
    Controller.put_secure_browser_headers(conn, %{
      "content-security-policy" => "\
        ...
        default-src 'self';\
        script-src 'self' 'unsafe-inline' 'unsafe-eval' #{js_deliver_cdn_url} #{coinzillatag_url} #{google_url} https://www.gstatic.com;\
